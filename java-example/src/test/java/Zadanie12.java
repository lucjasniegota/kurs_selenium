...
public class Zadanie12 extends TestBase {
  ...
  public void litecartTest() {
    ...
    driver.findElement(By.name("new_images[]")).sendKeys("C:/kurs_selenium/java-example/src/test/resources/6.1.docx");
    driver.findElement(By.id("add-new-image")).click();
    List<WebElement> zdjecie = driver.findElements(By.name("new_images[]"));
    zdjecie.get(1).sendKeys("C:/kurs_selenium/java-example/src/test/resources/6.2.docx");
    new Actions(driver).click(driver.findElement(By.name("date_valid_from"))).release()
            .sendKeys("2010").sendKeys(Keys.TAB).sendKeys("1202").perform();
    new Actions(driver).click(driver.findElement(By.name("date_valid_to"))).release()
            .sendKeys("2010").sendKeys(Keys.TAB).sendKeys("1205").perform();
